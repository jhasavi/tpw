...
const slides = [
  ...
  },
  {
    ...
    subtitle: 'Keep Education Free for All',
    description: 'Your donation helps us empower more women through financial literacy',
    cta: 'Make a Donation',
    ctaLink: '/about#donate',
  },
  {
